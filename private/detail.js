//ajax for star selector and comments, from tutorial

$(document).ready(function(){
	var rating_data = 0;
    //if commends has been add, show them then
    ...
    function getUrlParam(name) {
        //Use regular expression get artwork id from URL
    ...
    function load_rating_data()
    {
      ...
      //use ajax display total comment area and comments
        $.ajax({
            url:"submit_rating.php",
            method:"POST",
